...
class ObjectDetection(Node):
    def __init__(self, img_size: Union[Tuple[int, int], None] = (640, 640)
        ...
        self.video_capture_left = cv2.VideoCapture("/dev/v4l/by-id/usb-046d_罗技高清网络摄像机_C930c_554D90DE-video-index0", cv2.CAP_V4L2)
    ...
    def YOLOv7_detect(self):
        ...
        if len(detections) == 0:
            ...
            my_bbox.header.stamp = self.get_clock().now().to_msg()
