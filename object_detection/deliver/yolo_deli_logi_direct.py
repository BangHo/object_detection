...
class ObjectDetection(Node):
    def __init__(self, img_size: Union[Tuple[int, int], None] = (640, 640)
        ...
        self.video_capture = cv2.VideoCapture("/dev/v4l/by-id/usb-046d_Logitech_Webcam_C930e_964D8E9E-video-index0", cv2.CAP_V4L2)
        ...
        self.visualization_publisher = self.create_publisher(Image, "/yolo_result", qos_profile_sensor_data)
        self.vis_msg = Image()

        # Publishers for detection
        self.detect_publisher = self.create_publisher(Detection2DArray, "/yolo_detect", qos_profile_sensor_data)
