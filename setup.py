...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'yolo_amz_right = object_detection.amz.yolo_amz_right:main',
            'yolo_amz_left = object_detection.amz.yolo_amz_left:main',
            'yolo_amz_sub = object_detection.amz.yolo_amz_sub:main',
            'sub_image = object_detection.etc.sub_image:main'
        ],
    },
)
